...
public class CppWebSocketController {
    ...
    @Autowired
    public CppWebSocketController(CppFileRepository cppFileRepository,
    ...
    public void handleCppExecution(@Payload String fileIdString, SimpMessageHeaderAccessor headerAccessor) {
        ...
        if (cppFile.isEmpty()) {
            ...
            messagingTemplate.convertAndSendToUser(sessionId, "/queue/errors", "File not found");
            return;
        }
